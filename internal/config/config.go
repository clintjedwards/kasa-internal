...
//
// All environment variables are prefixed with "INNERHAVEN". Ex: INNERHAVEN_DEBUG=true
//
// Most envvar configuration abides by common envvar string=string formatting: Ex. `export INNERHAVEN_DEBUG=true`.
// Complex envvars might take a json string as value.
//
//	Example: export INNERHAVEN_EXTENSIONS="{"name":"test"},{"name":"test2"}"
package config
